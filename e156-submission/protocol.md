...
Protocol: CT.gov Country Primary-Only Gap

This protocol isolates endpoint-only text gaps inside country-linked CT.gov portfolios. A primary-only gap is an eligible older closed interventional study missing the primary outcome description while retaining the detailed description field. Primary outputs rank country-linked portfolios with at least 500 linked studies by stock and rate.
